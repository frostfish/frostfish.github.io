...
;(function($) {
  ...
  var cartData,
    ...
    <form class="jqcart-orderform">\
      ...
      <p>\
        <button id="submit" class="btn btn-success" onclick="yaCounter49386922.reachGoal(\'ZAKAZ_IZ_KORZINY\'); return true;">Отправить заказ</button>\
...
$(function() {
  ...
  $.jqCart({
      buttons: '.btn-cart',
      handler: 'http://api.frost-fish.ru:5000/post-order',
